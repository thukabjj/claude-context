...
async function testLocalDeployment() {
    ...
    try {
        ...
        console.log(`✅ Embedding successful! Vector dimension: ${embeddingResult.length}`);
        console.log(`   First few values: [${embeddingResult.slice(0, 5).join(', ')}...]\n`);
        ...
        const searchResults = await vectorDb.search(collectionName, embeddingResult, {
            limit: 5,
